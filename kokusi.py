...
BOSS_LIST = [
    ...
    {"name": "にわとりボス", "hp": 2000, "image": "raion.png"},
]
...
# 仲間画像の座標とサイズをあらかじめ定義
FRIEND_POSITIONS = [
    {"file": "kurosiba.png", "pos": "100% 65%", "size": "100px"},  # 1匹目
    {"file": "dora.png",     "pos": "25% 40%", "size": "100px"},  # 2匹目
    {"file": "rai.png",  "pos": "45% 20%", "size": "100px"},  # 3匹目
]
